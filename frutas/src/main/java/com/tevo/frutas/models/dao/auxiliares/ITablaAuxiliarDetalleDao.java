package com.tevo.frutas.models.dao.auxiliares;
...
import com.tevo.frutas.models.entity.auxiliares.TablaAuxiliarDetalleId;
...
public interface ITablaAuxiliarDetalleDao extends CrudRepository<TablaAuxiliarDetalle, TablaAuxiliarDetalleId> {
	...
	public List<TablaAuxiliarDetalle> listDropdownByCodigoMerma(String codTablaAuxiliar, Long id);
}
